...
export const GITHUBACTIONS_MODEL_PROMPT = `You are reviewing GitHub Actions workflows for security, supply-chain, and reliability defects.
...
export const GITHUBACTIONS_MODEL_SCHEMA: Record<string, unknown> = {
  type: "object",
...
export async function runModelGithubActionsReview(
  ctx: RuleContext,
  detections: DetectionInput[],
  sources: SourceInput[],
...
async function applyModelGithubActionsReview(
  ctx: RuleContext,
